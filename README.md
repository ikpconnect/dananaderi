...
This repository is set up as a **template**: every personal field (name, email, social handles, projects, publications, etc.) has been replaced with a placeholder. Fork it, search for `Your Name` / `your-username` / `your.email@example.com` to find what to replace, and you're off.
